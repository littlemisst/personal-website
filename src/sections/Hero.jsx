    ...
    <Page
      children={
        <>
          <div className="grid grid-cols-5 absolute">
            <div className='col-start-2 col-end-4'>
              ...
              <div className='flex justify-start items-center pb-4'>
                <h1 className='text-3xl font-nunito font-bold text-indigo'>I’m Teofy - Software Developer and an aspiring UX/UI Designer.</h1>
              </div>
          ...
          <div><Spline scene="https://prod.spline.design/zORW-DjtTQQz1CJM/scene.splinecode" /></div>
        </>
      }
      id='hero'
    />
